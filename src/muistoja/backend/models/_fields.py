...
TEXT = constr(strip_whitespace=True, min_length=1, max_length=20_000)
SMALL_TEXT = constr(strip_whitespace=True, min_length=1, max_length=2_500)
LONG_TEXT = constr(strip_whitespace=True, min_length=1, max_length=100_000)
